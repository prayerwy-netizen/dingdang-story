...
const getClassName = (className?: string, size?: IconProps['size']) => {
...
export const ChevronLeftIcon: React.FC<IconProps> = ({ className, size }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
...
export const HomeIcon: React.FC<IconProps> = ({ className, size = 'xl' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const BookIcon: React.FC<IconProps> = ({ className, size = 'xl' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const LockIcon: React.FC<IconProps> = ({ className, size = 'lg' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const GiftIcon: React.FC<IconProps> = ({ className, size = 'xl' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const ListIcon: React.FC<IconProps> = ({ className, size = 'xl' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const FlowerIcon: React.FC<IconProps> = ({ className, size }) => (
  <svg
...
export const PlusIcon: React.FC<IconProps> = ({ className, size = 'lg' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
...
export const SwitchIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={getClassName(className, size)}
    fill="none"
    stroke="currentColor"
